                              ...
                              <div class="flex flex-wrap -m-2">
                                ...
                                <div class="p-2 w-full">                            
                                    <div class="flex flex-col items-center space-y-4">
                                        ...
                                        class="text-white bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg w-48 text-center"
                                        >
                                        一覧に戻る
                                        </Link>

                                        <!-- 編集する -->
                                        <Link as="a" :href="route('items.edit', { item: item.id })"
                                        class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg w-48 text-center"
                                        >
                                        編集する
                                        </Link>
                                        ...
                                        class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg w-48 text-center"
                                        >
                                        削除する
                                        </button>
                                    </div>
