                      ...
                      <div class="p-2 w-full">
                        <div class="relative">
                          ...
                          <div class="flex items-center mt-2">
                            <input type="radio" id="selling-yes" name="is_selling" v-model="form.is_selling" :value="1">
                            <label for="selling-yes" class="ml-2 mr-4">販売中</label>

                            <input type="radio" id="selling-no" name="is_selling" v-model="form.is_selling" :value="0">
                            <label for="selling-no" class="ml-2">停止中</label>
                          </div>
                        </div>
                      </div>
